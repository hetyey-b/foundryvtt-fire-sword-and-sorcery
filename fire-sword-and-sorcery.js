...
import FSSHirelingSheet from "./module/sheet/FSSHirelingSheet.js";
...
Hooks.once("init", function() {
    ...
    Actors.registerSheet("fire-sword-and-sorcery", FSSHirelingSheet, { types: ["hireling"], makeDefault:true });
